...
<body>
	...
	<ul id="framework-front" class="dropdown-content">
	...
	<nav>
		<div class="nav-wrapper sub-menu">
			<ul class="right hide-on-med-and-down">
				...
				<li><a class="dropdown-trigger" href="#!" data-target="framework-front">Frameworks - Front-end<i class="material-icons right">arrow_drop_down</i></a></li>
				<li><a class="dropdown-trigger" href="#!" data-target="framework-back">Frameworks - Back-end<i class="material-icons right">arrow_drop_down</i></a></li>
